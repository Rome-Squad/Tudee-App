...
val lightThemeColor = TudeeColors(
    ...
    primaryGradient = Gradient(Color(0xFF49BAF2), Color(0xFF3A9CCD)),
    title = Color(0xDD1F1F1F),
    body = Color(0x991F1F1F),
    hint = Color(0x611F1F1F),
    stroke = Color(0x1E1F1F1F),
    emojiTint = Color(0xDD1F1F1F),
    ...
    onPrimaryCard = Color(0x28FFFFFF),
